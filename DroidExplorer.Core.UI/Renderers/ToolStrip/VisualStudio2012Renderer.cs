...
namespace DroidExplorer.Core.UI.Renderers.ToolStrip {
	public class VisualStudio2012Renderer : ToolStripProfessionalRenderer {
		public VisualStudio2012Renderer ( )
			: base ( new VisualStudio2012ColorTable ( ) ) {

		}
	}
	public class VisualStudio2012ColorTable : ProfessionalColorTable {
