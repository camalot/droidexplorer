...
namespace DroidExplorer.Plugins {
	public class SdkManager : BasePlugin {
		public SdkManager(IPluginHost host)
			: base(host) {
		...
		public override string Url {
			get { return "http://developer.android.com/tools/help/sdk-manager.html"; }
		}
		...
		public override string Description {
			get { return "Launch Android SDK Manager"; }
		}
		...
		public override bool CreateToolButton {
			get { return FolderManagement.ToolExists ( CommandRunner.SDKMANAGER_COMMAND ); }
		}

		public override System.Drawing.Image Image { get { return DroidExplorer.Resources.Images.svd_manager; } }
		...
		public override void Execute(IPluginHost pluginHost, Core.IO.LinuxDirectoryInfo currentDirectory, string[] args) {
			CommandRunner.Instance.LaunchSdkManager();
		}
		#endregion
	}
}
